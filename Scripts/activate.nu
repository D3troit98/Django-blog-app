...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Acer\Downloads\blog-app-dyango\Django-blog-app'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Acer\Downloads\blog-app-dyango\Django-blog-app\Scripts\deactivate.nu'
